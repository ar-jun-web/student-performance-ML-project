...
# ══════════════════════════════════════════════════════════════
st.set_page_config(
    page_title="SmartPredict | Student Performance AI",
    page_icon="🎯",
    layout="wide",
...
with st.sidebar:
    ...
    <div style='text-align:center; padding:1.5rem 0 1rem 0;'>
        ...
        <div style='font-size:1.5rem; font-weight:800; color:#a5b4fc; margin-bottom:0.3rem;'>SmartPredict</div>
...
<div class='hero-container animate-in'>
    <div style='position:relative; z-index:1;'>
        ...
        <h1 class='hero-title'>SmartPredict AI</h1>
...
<div style='text-align:center; color:#475569; font-size:0.85rem; 
    ...
    <div style='margin-bottom:0.5rem;'>🎓 SmartPredict AI - Advanced Student Performance Analytics</div>
